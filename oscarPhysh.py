...
if __name__ == "__main__":
    try:
        ...
        port = '8080' # When Keyword Interrupt Occurs before defining Port by User. Script will use 8080 port.(Just To Remove Exception Errors)| Le script utilisera le port 8080 si il est interrompu d'une quelconque manière.
